...
export default function TaskForm({
  ...
  const [dueAt, setDueAt] = useState(initialValues.due_at ? initialValues.due_at.slice(0, 10) : "");
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <div className={styles.field}>
        <label className={styles.label} htmlFor="tf-status">
          Status
        </label>
        <select
          id="tf-status"
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          <label className={styles.label} htmlFor="tf-exp">
            Experience
          </label>
          <select
            id="tf-exp"
        ...
        <div className={styles.field}>
          <label className={styles.label} htmlFor="tf-due">
            Due date
          </label>
          <input
            id="tf-due"
